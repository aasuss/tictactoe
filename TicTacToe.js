...
function ticTacToe() {
  ...
  function setCellProperties(id) {
    ...
    if (cellId < 10) var cello = document.getElementById(cellId + 11);
    else var cello = document.getElementById(cellId - 11);
    cell.unWritten = true;
  ...
  for (var i = 0; i < 9; i++) {
    if (player1Turn % 2 == 0) setCellProperties(i);
  }
  for (var i = 11; i < 20; i++) {
    if (!player1Turn % 2 == 0) setCellProperties(i);
  }
  ...
  function checkWin(gridToCheck, who) {
    ...
    function checkCombo(cell1, cell2, cell3, who) {
      if (
        gridToCheck[cell1] === true &&
        gridToCheck[cell2] === true &&
        gridToCheck[cell3] === true
      ) {
  ...
  function checkTie() {
    if (
      tieDetectorGrid[0] === true &&
      tieDetectorGrid[1] === true &&
      tieDetectorGrid[2] === true &&
      tieDetectorGrid[3] === true &&
      tieDetectorGrid[4] === true &&
      tieDetectorGrid[5] === true &&
      tieDetectorGrid[6] === true &&
      tieDetectorGrid[7] === true &&
      tieDetectorGrid[8] === true
    ) {
    ...
    if (
      tieDetectorGrid[11] === true &&
      tieDetectorGrid[12] === true &&
      tieDetectorGrid[13] === true &&
      tieDetectorGrid[14] === true &&
      tieDetectorGrid[15] === true &&
      tieDetectorGrid[16] === true &&
      tieDetectorGrid[17] === true &&
      tieDetectorGrid[18] === true &&
      tieDetectorGrid[19] === true
    ) {
      //Checks if board is full
